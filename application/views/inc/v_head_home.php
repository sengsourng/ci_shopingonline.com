...
<html lang="en">
  ...
  <link rel="apple-touch-icon-precomposed" sizes="57x57" href="<?php echo base_url ();?>public/<?php echo base_url ();?>public/images/ico/apple-touch-icon-57-precomposed.png">
  <!-- icons -->
