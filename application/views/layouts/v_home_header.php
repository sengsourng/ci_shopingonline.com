				...
				<div class="navbar-left">
					<div class="collapse navbar-collapse" id="navbar-collapse">
						...
						<!-- 	<li class="active dropdown"><a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown">Home <span class="caret"></span></a>
							...
							<li><a href="<?php echo site_url(); ?>Welcome/categories">Category</a></li>
							
							
							<li><a href="<?php echo site_url(); ?>Welcome/details">all ads</a></li>
							
							<li><a href="<?php echo site_url(); ?>Welcome/faq">Help/Support</a></li> 
						...
						<!-- <li class="dropdown"><a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown">Pages <span class="caret"></span></a>
								<ul class="dropdown-menu">
									...
									<li><a href="<?php echo site_url(); ?>Welcome/categories">Category Ads</a></li>
									<li><a href="<?php echo site_url(); ?>Welcome/details">Ad Details</a></li>
							...
							<li class="active" ><a href="<?php echo site_url(); ?>Welcome/page">Page</a></li> 
